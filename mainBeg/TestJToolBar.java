...
{  
    ...
    AbstractAction pasteAction = new AbstractAction("粘贴", new ImageIcon("ico/paste.png"))  
    {  
    ...
    //创建"复制"Action  
    AbstractAction copyAction = new AbstractAction("复制", new ImageIcon("ico/copy.png"))  
    {  
        public void actionPerformed(ActionEvent e)  
        {  
